...
MICO_3Dseq({['C:\Users\Tim\Documents\Work\Cortical_Networks\Data\JN_tmp\MRI\r' subname{1} '_ss.nii']}, N_region, q, th_bg, iterNum_outer, iter_b, iterCM, tissueLabel);

segmri = ft_read_mri([datapathr subname{1} '_tmp\MRI\r' subname{1} '_ss_seg.nii'],'dataformat','nifti_spm');
...
sens = ft_read_sens([datapathr subname{1} '_tmp\jn270257_vladimirDBS_20090731_01.ds'],'senstype','meg');
% PLOT
% close all
% figure
...
%% Prepare Leadfield
cfg = [];
cfg.datafile = [datapathr subname{1} '_tmp\jn270257_vladimirDBS_20090731_01.ds'];
cfg.lpfilter = 'yes';
cfg.hpfilter = 'yes';
cfg.channel         = {'MEG'};
cfg.lpfreq = 18;
