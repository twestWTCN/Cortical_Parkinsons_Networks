function BB  = compute_BetaBursts(R,BB,data,cond,shuff)
%% compute_BetaBursts - Wavelet Decomposition for Amplitude/Phase/Phase Locking
...
for band = 3 % Optionally can do across predefined bands
    ...
    % Sliding Window
    winsize = 1.5.*data.fsample; % Window Size
    overlap = 0.99; %
