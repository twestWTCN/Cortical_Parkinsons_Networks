function compute_leadfield_DICS_v2(R,steps,fresh)
for sub = 1:numel(R.subname)
    ...
    for cond = 1:2
        ...
        for nr = nrep % Use the later trial
            ...
            cfg.lpfilter = 'yes';
            cfg.hpfilter = 'yes';
            cfg.lpfreq = R.dics.bp(2);
            cfg.hpfreq = R.dics.bp(1);
                ...
                for meth = 1:numel(steps)
                    switch steps{meth}
                        case 'leadfield'
                            ...
                            save([R.datapathr R.subname{sub} '\ftdata\r' R.subname{sub} '_DICSv2_peakinfo_source' R.condname{cond} 'nrep_' num2str(nr) '_' ref_chan],'DICS_peak')
                            save([R.datapathr R.subname{sub} '\ftdata\r' R.subname{sub} '_DICSv2_source' R.condname{cond} 'nrep_' num2str(nr) '_' ref_chan],'source','-v7.3')
